...
int token;
int nextToken;
ifstream myFile("C:\\Users\\ilive\\Documents\\UTD\\2020-Summer\\CS4337-0U2\\assignments\\q5\\q5\\forStmt.txt");	// Put the file location here to run the code. <- SUPER IMPORTANT
